...
SECRET_KEY = "django-insecure-7a-qwgm1bls%4%v*^xgd7(g-=3#7*sy2)i23dfpn7@dfg50lu7"
...
SIMPLE_JWT = {
    ...
    "TOKEN_OBTAIN_SERIALIZER": "delish.serializers.MyTokenObtainPairSerializer",
